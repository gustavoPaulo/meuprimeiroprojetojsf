...
public class PessoaBean implements Serializable {
	...
	public String salvar() throws IOException{
		...
		// INICIO -> Processar imagem
			...
			//Escrever novamente a imagem em tamnho já reduzida
	...
	public void download() throws IOException {
		...
		response.addHeader("Content-Disposition", "attachment; filename=arquivo." + pessoa.getExtensao());
	...
	public void midancaDeValor(ValueChangeEvent event) {
		
		System.out.println("Sobrenome Antigo: " + event.getOldValue());
		System.out.println("Sobrenome Novo: " + event.getNewValue());
	}
}